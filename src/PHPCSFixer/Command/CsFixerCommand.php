...
final class CsFixerCommand extends BaseCommand
{
    ...
    private const string DEFAULT_CONFIG_FILE = __DIR__ . '/../../../dist/php-cs-fixer.php.dist';
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addOption(
                ...
                'Path to a PHP CS Fixer config file (defaults to the template published by this package)'
            )
            ->addOption(
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $phpCsFixerBinary = sprintf('%s/bin/php-cs-fixer', $vendorDir);
        ...
        $configSource = $input->getOption(self::OPTION_CONFIG) ?? self::DEFAULT_CONFIG_FILE;
